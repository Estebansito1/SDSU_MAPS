...
//////////
    ...
    // search down the tree comparing keyss
...
//////////////
    // private helper logic contains the internal root paointer and
    // and recursive insert function.
    private:
        BuildingNode* root;
